...
Object detection, relation extraction, open domain question answering 등 다양한 대회와 프로젝트에 진행하며 딥러닝 모델과 Pytorch, 그리고 Huggingface의 숙련도를 높일 수 있는 기회를 가졌다. SentenceBert와 dense embedding retrieval 등 dense embedding을 이용한 효율화를 가장 집중적으로 연구하였다.
##
...
### _결장암 치료 임상실험 데이터 생존분석_ | Fall 2020
`#생존 분석` `#시각화` `#R`

[분석 발표](https://drive.google.com/file/d/1PrkjF8lVKZxez8uee-juP5B7tvsxxVxa/view?usp=sharing)

구충약 성분인 레비마솔과 5-플로우로라실의 결장암 치료 효과 분석
- COX PH 모델 적용 가능 여부를 검증 (Schoenfeld Residuals 시각화)
- COX PH 모델 가정 하에서 Backward Regression을 통해 유의미한 변수만 선별
- 치료제의 치료 효과 
##
...
아래는 국립대만대학교 대학원에서 교환학생으로 이수한 수업들입니다

### 컴퓨터 과학
- Deep Learning Optimization Seminar

### 산업공학과
- Data Analysis
##

아래는 MOOC강의로 코세라에서 수강한 수업들입니다

### 컴퓨터과학
- [자료구조](https://www.coursera.org/account/accomplishments/verify/7ZDT9MKLRVQF)
- [알고리즘](https://www.coursera.org/account/accomplishments/verify/NTXQJUDF4NQM)
